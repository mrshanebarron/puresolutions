    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div class="gsap-reveal">
                <span class="gold-line mb-6"></span>
                <h2 class="font-heading text-3xl md:text-4xl font-bold text-dark mb-6">Our Story</h2>
...
<section class="py-16 bg-light">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto text-center gsap-reveal">
            ...
            <h2 class="font-heading text-3xl font-bold text-dark mb-6">Our Mission</h2>
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-14 gsap-reveal">
            ...
            <h2 class="font-heading text-3xl md:text-4xl font-bold text-dark mb-4">Our Values</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 gsap-stagger">
            <div class="text-center p-8 gsap-stagger-item">
                ...
                <h3 class="font-heading text-xl font-bold text-dark mb-3">Integrity</h3>
            ...
            <div class="text-center p-8 gsap-stagger-item">
                ...
                <h3 class="font-heading text-xl font-bold text-dark mb-3">Innovation</h3>
                <p class="text-text-light text-sm leading-relaxed">
            ...
            <div class="text-center p-8 gsap-stagger-item">
                ...
                <h3 class="font-heading text-xl font-bold text-dark mb-3">Partnership</h3>
                <p class="text-text-light text-sm leading-relaxed">
            ...
            <div class="text-center p-8 gsap-stagger-item">
                ...
                <h3 class="font-heading text-xl font-bold text-dark mb-3">Results</h3>
                <p class="text-text-light text-sm leading-relaxed">
...
<section class="py-20 bg-light">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-14 gsap-reveal">
            <span class="gold-line mx-auto mb-6"></span>
            <h2 class="font-heading text-3xl md:text-4xl font-bold text-dark mb-4">Our Approach</h2>
            <p class="text-text-light text-lg max-w-2xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 gsap-stagger">
            <div class="relative gsap-stagger-item">
                <div class="bg-white rounded-xl p-8 shadow-sm relative z-10">
                    ...
                    <h3 class="font-heading text-lg font-bold text-dark mb-3">Discover</h3>
                    <p class="text-text-light text-sm leading-relaxed">
            ...
            <div class="relative gsap-stagger-item">
                <div class="bg-white rounded-xl p-8 shadow-sm relative z-10">
                    ...
                    <h3 class="font-heading text-lg font-bold text-dark mb-3">Design</h3>
                    <p class="text-text-light text-sm leading-relaxed">
            ...
            <div class="relative gsap-stagger-item">
                <div class="bg-white rounded-xl p-8 shadow-sm relative z-10">
                    ...
                    <h3 class="font-heading text-lg font-bold text-dark mb-3">Implement</h3>
                    <p class="text-text-light text-sm leading-relaxed">
            ...
            <div class="relative gsap-stagger-item">
                <div class="bg-white rounded-xl p-8 shadow-sm relative z-10">
                    ...
                    <h3 class="font-heading text-lg font-bold text-dark mb-3">Sustain</h3>
                    <p class="text-text-light text-sm leading-relaxed">
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-14 gsap-reveal">
            <span class="gold-line mx-auto mb-6"></span>
            <h2 class="font-heading text-3xl md:text-4xl font-bold text-dark mb-4">Leadership Team</h2>
            <p class="text-text-light text-lg max-w-2xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 gsap-stagger">
            ...
            <div class="team-card bg-light rounded-xl overflow-hidden shadow-sm gsap-stagger-item">
                ...
                <div class="p-8">
                    <h3 class="font-heading text-xl font-bold text-dark mb-1">James Whitfield</h3>
            ...
            <div class="team-card bg-light rounded-xl overflow-hidden shadow-sm gsap-stagger-item">
                ...
                <div class="p-8">
                    <h3 class="font-heading text-xl font-bold text-dark mb-1">Dr. Susan Park</h3>
            ...
            <div class="team-card bg-light rounded-xl overflow-hidden shadow-sm gsap-stagger-item">
                ...
                <div class="p-8">
                    <h3 class="font-heading text-xl font-bold text-dark mb-1">Michael Torres</h3>
