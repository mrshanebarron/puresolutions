    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div class="gsap-reveal">
                ...
                <h2 class="font-heading text-3xl md:text-4xl font-bold text-navy mb-6">Strategic Procurement</h2>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="gsap-reveal order-1 lg:order-2">
                ...
                <h2 class="font-heading text-3xl md:text-4xl font-bold text-navy mb-6">Operational Optimization</h2>
                <p class="text-text-light text-lg leading-relaxed mb-6">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div class="gsap-reveal">
                ...
                <h2 class="font-heading text-3xl md:text-4xl font-bold text-navy mb-6">Technology Enablement</h2>
                <p class="text-text-light text-lg leading-relaxed mb-6">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="gsap-reveal order-1 lg:order-2">
                ...
                <h2 class="font-heading text-3xl md:text-4xl font-bold text-navy mb-6">Flexible Support Packages</h2>
                <p class="text-text-light text-lg leading-relaxed mb-6">
                ...
                <div class="space-y-6 mb-8">
                    <div class="bg-white rounded-lg p-6 shadow-sm">
                        <h3 class="font-heading text-lg font-bold text-navy mb-2">Ongoing Advisory</h3>
                    ...
                    <div class="bg-white rounded-lg p-6 shadow-sm">
                        <h3 class="font-heading text-lg font-bold text-navy mb-2">Project-Based Engagements</h3>
                        <p class="text-text-light text-sm leading-relaxed">
                    ...
                    <div class="bg-white rounded-lg p-6 shadow-sm">
                        <h3 class="font-heading text-lg font-bold text-navy mb-2">Interim Management</h3>
                        <p class="text-text-light text-sm leading-relaxed">
